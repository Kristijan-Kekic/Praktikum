...
const { trigramGenerator, generateChunks, whitespaceHandler, interpunctionHandler } = require("../trigramGenerator");
...
describe('interpunctionHandler', function() {
    ...
    it('should put interpunctions as seperate words', function () {
        expect(interpunctionHandler(' I wish. ')).to.eql('I wish .');
        expect(interpunctionHandler(' I wish!.? ')).to.eql('I wish ! . ?');
        expect(interpunctionHandler(' I wish! ')).to.eql('I wish !');
    });
});
...
describe('textParsing', function() {
    ...
    it("handles interpunctions as a separate word", function() {
